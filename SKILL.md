---
name: "pocketbase_go"
description: "Manages PocketBase backend with Go type-safe client. Handles atomic schema operations, sync, and code generation."
version: "1.1.0"
author: "Antigravity"
tags: ["pocketbase", "go", "backend", "migration"]
---
...
0.  **Setup (First Time Only)**:
    -   Copy required files to project root: `cp skills/pocketbase-go/resources/{Makefile,pb_migrate_ops.py,Dockerfile} .`
